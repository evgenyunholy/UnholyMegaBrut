...
print('=============================================== BitcoinBalanceChecker =================================================')
ctypes.windll.kernel32.SetConsoleTitleW("                                                                                                                               BitcoinBalanceChecker")
...
res = myself.parents[1] / 'FOLDERFORCHEKBALANCE/btc.txt'

myselff = Path(__file__).resolve()
ress = myself.parents[1] / 'FOLDERFORCHEKBALANCE/addresses-with-balance.txt'
